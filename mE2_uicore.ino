...
const uint8_t uicore_content_relation_count = 75;
...
////////////////////////////////////////////////////////
// SETTINGS PANORAMA
//2015-02-11 CH Added PAN Settings

const char* string_600_short = "Panorama Modus";
...
void uicore_getShortString(uint16_t buf_number, uint8_t target_line) {
  ...
  switch(buf_number) {
    ...
    case  504: strcpy(lines[target_line], string_504_short);      return;    
    case  505: strcpy(lines[target_line], string_505_short);      return;    
    ///////////////////////////////////////////////////////////////////
    // SYSTEM MODES
    ...
    case 600: strcpy(lines[target_line], string_600_short);     return;
    case 601: strcpy(lines[target_line], string_601_short);     return;
    case 602: strcpy(lines[target_line], string_602_short);     return;
    
    case 700: strcpy(lines[target_line], string_700_short);     return;
    case 701: strcpy(lines[target_line], string_701_short);     return;
    ...
    case 209: strcpy(lines[target_line], string_209_short);     return;  
...
void uicore_getLongString(uint16_t buf_number) {
  ...
  switch(buf_number) {
    ...
    case 600: strcpy(data_line, string_600_long);     return;
    case 601: strcpy(data_line, string_601_long);     return;
    case 602: strcpy(data_line, string_602_long);     return;

    case 700: strcpy(data_line, string_700_long);     return;
    case 701: strcpy(data_line, string_701_long);     return;
  ...
  switch (line_code) {
    ...
    case 600 : {
                  if (menu_editing) {
                    ...
                    // show the long strings when in editing mode
                    if      (isBit(pano_mode, PANO_MODE_AUTO)) strcpy(data_line, string_700_long);
                    else if (isBit(pano_mode, PANO_MODE_MAN))     strcpy(data_line, string_701_long);
                    
                  } else {
                   
                   // show the short strings when in editing mode 
                   if      (isBit(pano_mode, PANO_MODE_AUTO)) strcpy(data_line, string_700_short);
                   else if (isBit(pano_mode, PANO_MODE_MAN))     strcpy(data_line, string_701_short);                     
                  }
    ...
    case 601 :  {
                if (menu_editing) {
                 strcpy(data_line, string_601_long);
                 strcpy(data_line, string_600_short); 
                 }
                break; 
    ...
    case 602 :  {
                if (menu_editing) {
                 strcpy(data_line, string_602_long); 
                }
    }    
