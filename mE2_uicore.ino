...
// 40:  Panorama       run setup         >> Panorama                                          //
//                                                                                            //
//                                                                                            //
...
const uint8_t uicore_content_relation_count = 82;

// our menu tree
//2015-02-11 CH Added pano menu 
struct uiRelation ui_content_relations[uicore_content_relation_count] = {
    
  {  10, 202 }, {  10, 203 }, {  10, 204 }, {  10, 205 }, {  10, 140 }, {  10, 200 }, {  10, 201 }, {  10, 206 }, {  10, 207 },                                                                                   //9
  {  11, 202 }, {  11, 204 }, {  11, 205 },                                                                                                                                                                       //3
  {  15, 202 },                                                                                                                                                                                                   //1
  {  20, 202 }, {  20, 203 }, {  20, 204 }, {  20, 205 }, {  20, 140 }, {  20, 200 }, {  20, 201 }, {  20, 206 }, {  20, 207 },                                                                                   //9
  {  21, 202 }, {  21, 204 }, {  21, 205 },                                                                                                                                                                       //3
  {  30, 203 }, {  30, 140 }, {  30, 200 }, {  30, 201 }, {  30, 206 }, {  30, 207 },                                                                                                                             //6
  {  31,  23 },                                                                                                                                                                                                   //1
  {  40, 202 }, {  40, 243 }, {  40, 244 }, {  40, 245 }, {  40, 246 }, {  40, 247 }, {  40, 248 },                                                                                                               //7
  
    
  { 100, 108 }, { 100, 109 }, { 100, 111 }, { 100, 100 }, { 100, 101 }, { 100, 102 }, { 100, 107 }, { 100, 103 }, { 100, 110 }, { 100, 112 },                                                                     //10
  { 101, 120 }, { 101, 121 }, { 101, 122 },                                                                                                                                                                       //3
  { 102, 140 }, { 102, 150 }, { 102, 154 }, { 102, 141 }, { 102, 142 }, { 102, 143 }, { 102, 144 }, { 102, 145 }, { 102, 161 }, { 102, 146 }, { 102, 151 }, { 102, 155 }, { 102, 213 }, /* { 102, 147 }, */       //13
    
  { 103,  23 }, /*{ 103, 160 }, { 103, 161 }, */                                                                                                                                                                  //1
  { 104, 180 }, { 104, 181 }, { 104, 182 }, { 104, 183 }, { 104, 187 },                                                                                                                                           //5
  { 105, 242 }, { 105, 249 }, { 105, 250 }, { 105, 251 }, { 105, 238 },                                                                                                                                           //5  
  
  { 200, 152 }, { 200, 148 }, { 200, 149 }, { 200, 156 }, { 200, 157 }, { 200, 160 },                                                                                                                             //6
...
void uicore_getShortString(uint16_t buf_number, uint8_t target_line) {
  ...
  switch(buf_number) {
    ...
    case  99: strcpy(lines[target_line], string_99_short);      return;  
    ...
    //2015-02-11 CH Added string copy pano options 
    case 241: strcpy(lines[target_line], string_241_short);     return;
    case 242: strcpy(lines[target_line], string_242_short);     return;
    case 243: strcpy(lines[target_line], string_243_short);     return;
    case 244: strcpy(lines[target_line], string_244_short);     return;
    case 245: strcpy(lines[target_line], string_245_short);     return;
    case 246: strcpy(lines[target_line], string_246_short);     return;
    case 247: strcpy(lines[target_line], string_247_short);     return;
    case 248: strcpy(lines[target_line], string_248_short);     return;
    case 249: strcpy(lines[target_line], string_249_short);     return;
    case 250: strcpy(lines[target_line], string_250_short);     return;
    case 251: strcpy(lines[target_line], string_251_short);     return;
    case 252: strcpy(lines[target_line], string_252_short);     return;
    case 253: strcpy(lines[target_line], string_253_short);     return;
    case 254: strcpy(lines[target_line], string_254_short);     return;
    case 255: strcpy(lines[target_line], string_255_short);     return;
    case 239: strcpy(lines[target_line], string_239_short);     return;
    case 238: strcpy(lines[target_line], string_238_short);     return;
    case 237: strcpy(lines[target_line], string_237_short);     return;
    case 236: strcpy(lines[target_line], string_236_short);     return;
    //case 244: strcpy(lines[target_line], string_244_short);     return;
...
void uicore_getLongString(uint16_t buf_number) {
  ...
  switch(buf_number) {
    ...
    case 240: strcpy(data_line, string_240_long);     return;
    case 241: strcpy(data_line, string_241_long);     return;
    case 242: strcpy(data_line, string_242_long);     return;
    case 243: strcpy(data_line, string_243_long);     return;
    case 244: strcpy(data_line, string_244_long);     return;
    case 245: strcpy(data_line, string_245_long);     return;
    case 246: strcpy(data_line, string_246_long);     return;
    case 247: strcpy(data_line, string_247_long);     return;
    case 248: strcpy(data_line, string_248_long);     return;
    case 249: strcpy(data_line, string_249_long);     return;
    case 250: strcpy(data_line, string_250_long);     return;
    case 251: strcpy(data_line, string_251_long);     return;
    case 252: strcpy(data_line, string_252_long);     return;
    case 253: strcpy(data_line, string_253_long);     return;
    case 254: strcpy(data_line, string_254_long);     return;
    case 255: strcpy(data_line, string_255_long);     return;
    case 239: strcpy(data_line, string_239_long);     return;
    ...
    // no popup menu
      ...
      if (!menu_editing) {
        ...
        // we are allready in the menu
          ...
          screen_code++;
          if (screen_code > 105) screen_code = 100; 
...
boolean uicore_isSettingsScreen() {
  ...
  return (screen_code >= 100) && (screen_code <= 105);  
